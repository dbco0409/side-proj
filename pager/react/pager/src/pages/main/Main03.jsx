      ...
      >
            <SwiperSlide className="slide01">
                <div className="box">
                    ...
                    <button className="btn" onClick={() => goTo("/ordering/view/R25DD20429390")}>발주 공고 상세 보기</button>
                </div>
            </SwiperSlide>
            <SwiperSlide className="swiper-slide slide02">
                <div className="box">
                    ...
                    <button className="btn" onClick={() => goTo("/bid/view/R25BK01115399")}>입찰 공고 상세 보기</button>
                </div>
            </SwiperSlide>
        </Swiper>
	</section>
