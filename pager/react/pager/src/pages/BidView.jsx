      ...
      <section id="sub_view">
        <div className="viewGroup" id="viewGroup">
          ...
          <dl className="tb_set">
            ...
            <div className="dl-item dl-line-right">
              <dt>공고종류</dt>
              <dd>{item.ntceDivNm || "-"}</dd>
            </div>
            <div className="dl-item">
              <dt>입찰방식</dt>
              <dd>{item.bidMethdNm || "-"}</dd>
            </div>
            <div className="dl-item dl-line-right">
              <dt>낙찰방식</dt>
              <dd>{item.sucsfbidMthdNm || "-"}</dd>
            </div>
          </dl>
          ...
          <dl className="tb_set">
            ...
            <div className="dl-item dl-line-right">
              <dt>담당자 연락처</dt>
              <dd>{item.ofclTelNo || "-"}</dd>
            </div>
            <div className="dl-item">
              <dt>담당자 이메일</dt>
              <dd>{item.ofclEmail || "-"}</dd>
            </div>
          </dl>
